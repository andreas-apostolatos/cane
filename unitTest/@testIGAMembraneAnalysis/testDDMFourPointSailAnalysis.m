...
[BSplinePatchesPenalty,~,~,resHistoryPenalty,~,~] = solve_DDMFormFindingIGAMembrane...
    (BSplinePatchesPenalty,connections,propCouplingPenalty,propFormFinding,...
    solve_LinearSystem,'');
...
[BSplinePatchesLM,~,~,resHistoryLM,~,~] = solve_DDMFormFindingIGAMembrane...
...
% % -------------------------------------------------------
% 
% [BSplinePatchesMortar,~,~,resHistoryMortar,~,~] = solve_DDMFormFindingIGAMembrane...
...
[BSplinePatchesNitsche,~,propCouplingNitsche,resHistoryNitsche,~,~] = ...
    ...
    propCouplingNitsche,propFormFinding,solve_LinearSystem,'');
