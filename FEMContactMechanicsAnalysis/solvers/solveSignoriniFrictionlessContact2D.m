function [dHat, lambdaHat, nodeIDs_active, numInter, FComplete, minElSize] = ...
    ...
    computeBodyForces, propParameters, segmentsContact, computeStiffMtxLoadVct, ...
...
[K, F, minElSize] = computeStiffMtxLoadVct ...
    (propAnalysis, dHat_stiffMtx, uSaved, uDot, uDotSaved, uMeshALE, ...
    precompStiffMtx, precomResVct, DOFNumbering, strMsh, F, loadFactor, ...
    computeBodyForces, propStrDynamics, t, propParameters, propGaussInt);
...
%     end
    ...
    [dHat_stiffMtxLM, FComplete, ~, ~] = solve_FEMLinearSystem ...
        ...
        computeBodyForces, propParameters, dHat_stiffMtxLM, uDot, uDDot, ...
...
if ~isUnitTest
    ...
    writeOutputFEMPlateInMembraneActionToVTK...
        (propAnalysis, propNLinearAnalysis, propStrDynamics, strMsh, propParameters, ...
