function [dHistory,minElSize] = ...
    ...
    propNLinearAnalysis,propStrDynamics,solve_LinearSystem,gaussInt,...
...
[dHistory,minElSize] = solve_FEMTransientAnalysis...
    ...
    VTKResultFile,@computeConstantVerticalBodyForceVct,NBC,...
    ...
    propNLinearAnalysis,gaussInt,caseName,pathToOutput,title,DOF4Output,...
