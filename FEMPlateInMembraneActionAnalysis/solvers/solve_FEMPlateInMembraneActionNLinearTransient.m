function [dHistory, minElSize] = ...
    ...
    (propAnalysis, strMsh, homDOFs, inhomDOFs, valuesInhomDOFs, updateInhomDOFs, ...
    propNBC, computeLoadVct, parameters, computeBodyForces, propNLinearAnalysis, ...
    propIDBC, propStrDynamics, solve_LinearSystem, propGaussInt, propOutput, ...
    caseName, outMsg)
%% Licensing
%
% License:         BSD License
...
[dHistory,minElSize] = solve_FEMTransientAnalysis...
    ...
    valuesInhomDOFs, updateInhomDOFs, propALE, ...
    @computeInitCndsFEMPlateInMembraneAction, computeBodyForces, ...
    propNBC, computeLoadVct, parameters, @solve_FEMNLinearSystem, ...
    computeConstantMatrices, @computeMassMtxFEMPlateInMembraneAction, ...
    @computeTangentStiffMtxResVctFEMPlateInMembraneAction, ...
    computeUpdatedMesh, solve_LinearSystem, propStrDynamics, ...
    propNLinearAnalysis, propIDBC, propGaussInt, propOutput, caseName, ...
