function [dHat,FComplete,minElSize] = ...
    ...
    propNLinearAnalysis,propGaussInt,caseName,pathToOutput,isUnitTest,outMsg)
%% Licensing
%
% License:         BSD License
...
[dHat,FComplete,~,minElSize] = solve_FEMLinearSystem(analysis,uSaved,...
    ...
    massMtx,dampMtx,precomStiffMtx,precomResVec,computeStiffMtxLoadVct,...
    DOFNumbering,freeDOFs,homDOFs,inhomDOFs,valuesInhomDOFs,uMeshALE,...
    solve_LinearSystem,propStrDynamics,propNLinearAnalysis,propGaussInt,...
    tab,outMsg);
