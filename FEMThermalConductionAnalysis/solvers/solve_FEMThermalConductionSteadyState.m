function [THat, WComplete,minElSize] = solve_FEMThermalConductionSteadyState...
    (propAnalysis, strMsh, THat, homDOFs, inhomDOFs, valuesInhomDOFs, ...
...
%
%                 Output :
%                   THat : The nodal temperature field
%              WComplete : The energy rate
...
%% 3. Solve the linear equation system
[THat, WComplete, ~, minElSize] = solve_FEMLinearSystem ...
    (propAnalysis, uSaved, uDotSaved, uDDotSaved, strMsh, F, ...
    computeBodyForces, propParameters, THat, uDot, uDDot, massMtx, dampMtx, ...
            ...
            if isfield(propOutput, 'writeOutputToFile')
                if isa(propOutput.writeOutputToFile, 'function_handle')
                    ...
                    propOutput.writeOutputToFile...
                        ...
                        propStrDynamics, strMsh, propParameters, THat, ...
