function [uHistory_A, uHistory_B, resVctHistory_A, resVctHistory_B, ...
    ...
    propNLinearAnalysis_A, propNLinearAnalysis_B, propCoupling_A, ...
    propCoupling_B, propCoupling, propIDBC_A, propIDBC_B, propPostProc_A, ...
    propPostProc_B, propGaussInt_A, propGaussInt_B, propOutput_A, ...
    propOutput_B, caseName_A, caseName_B, pathToOutput_A, pathToOutput_B, ...
    title_A, title_B, DOF4Output_A, DOF4Output_B, tab, outMsg)
%% Licensing
%
% License:         BSD License
...
%                               .maxIter : The maximum number of nonlinear
%                                          iterations
%                propCoupling_A : Structure containing information on the
%                                 nodes along the coupling interface for
%                                 system A,
%                                       .nodes : Global numbering of the
%                                                nodes along the coupling 
%                                                interface
%                propCoupling_B : Structure containing information on the
%                                 nodes along the coupling interface for
%                                 system B,
%                                       .nodes : Global numbering of the
%                                                nodes along the coupling 
...
while t < propTransientAnalysis.TEnd && numTimeStep <= propTransientAnalysis.noTimeSteps
    ...
    [u_A, u_B, uDot_A, uDot_B, uDDot_A, uDDot_B, resVct_A, resVct_B, ...
        ...
        homDOFs_B, inhomDOFs_A, inhomDOFs_B, valuesInhomDOFs_A, ...
        valuesInhomDOFs_B, propALE_A, propALE_B, computeUpdatedMesh_A, ...
        computeUpdatedMesh_B, solve_LinearSystem_A, solve_LinearSystem_B, ...
        propTransientAnalysis_A, propTransientAnalysis_B, t, ...
        propNLinearAnalysis_A, propNLinearAnalysis_B, propCoupling_A, ...
        propCoupling_B, propCoupling, propPostProc_A, propPostProc_B, ...
        propGaussInt_A, propGaussInt_B, strcat(tab,'\t'), outMsg);
