...
[upHistory, dHistory, resVctHistoryFld, resVctHistoryStr, ...
    ...
    propNBCFld, propNBCStr, computeInitCndsFld, computeInitCndsStr, solve_FEMSystemFld, ...
    solve_FEMSystemStr, solve_FEMCoupledSystem, computeMassMtxFld, ...
    computeMassMtxStr, computeMtxSteadyStateFld, computeMtxSteadyStateStr, ...
    solve_LinearSystemFld, solve_LinearSystemStr, propFldDynamics, ...
    propStrDynamics, propNLinearAnalysisFld, propNLinearAnalysisStr, ...
    propFSIFld, propFSIStr, propFSI, propIDBCFld, propIDBCStr, ...
    propPostProcFld, propPostProcStr, propGaussIntFld, propGaussIntStr, ...
    propOutputFld, propOutputStr, caseNameFld, caseNameStr, 'outputEnabled');
