...
%        flow around a rigid cylinder which is attached on a spring.
%
% Date : 02.05.2020
%
%% Preamble
...
propFSIFld.nodes = propPostProcFld.nodesDomain;
propFSIStr = [];
...
solve_FEMCoupledSystem = @solve_FEMFluidMassSpringDamperInteractionPartitionedGaussSeidel;
