...
% caseName = 'BenchmarkHigStrRefined'; % needs the ALE module
% caseName = 'flowAroundCylinderAdaptiveALE'; % needs the ALE module
% caseName = 'NACA2412_AoA5_CFD'; % needs the ALE module
