...
propEmpireCoSimulation.isInterfaceLayer = true; % Flag on whether the matlab client is used as an interface layer
...
dt = 2e-3;
propStrDynamics.noTimeSteps = (TEnd - TStart)/dt;
