...
% 
% Task : Steady-state nonlinear analysis over a roof made of inflated tubes
%
% Date : 20.02.2017
%
%% Preamble
...
% parameters.prestress.voigtVector = @(theta)[sigma0
%                                             ((abs(FAmp)*radius)/(2*parameters.t))*((2*Radius + radius*sin(theta(2,1)))/(Radius + radius*sin(theta(2,1))))
%                                             0];
...
% weakDBC.imposedMotion = {@(x,y,z,t) [0; g20*sin(omega*t); 0]};
...
for iPatches = 1:noPatches
    ...
    for iCnd = 1:noCnd
        for iDir = 1:3
            xiSup = weakDBC.xiExtension{iCnd};
            etaSup = weakDBC.etaExtension{iCnd};
            homDOFs = findDofs3D(homDOFs,xiSup,etaSup,iDir,CP);
        end
    end
    assignin('base',['homDOFs' num2str(iPatches)],homDOFs);
end
...
for iNBC = 1
    ...
    FAmpWeight = - parameters.rho*parameters.t*9.8;
    dirWeight = 'z';
    scaling = 0; % 2e1, 4e1
    wind = scaling*1e1;
    ...
    NBC1.loadAmplitude = {FAmp1 FAmpWeight};
    NBC1.loadDirection = {dirForce1 dirWeight};
    NBC1.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC1.isFollower = [true; false];
    ...
    NBC2.xiLoadExtension = {xib2 xib2 xib2};
    NBC2.etaLoadExtension = {etab2 etab2 etab2};
    NBC2.loadAmplitude = {FAmp2 FAmpWeight wind};
    NBC2.loadDirection = {dirForce2 dirWeight 'y'};
    NBC2.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC2.isFollower = [true; false; false];
    NBC2.isTimeDependent = [false; false; false];
    ...
    NBC3.xiLoadExtension = {xib3 xib3 xib3};
    NBC3.etaLoadExtension = {etab3 etab3 etab3};
    NBC3.loadAmplitude = {FAmp3 FAmpWeight wind};
    NBC3.loadDirection = {dirForce3 dirWeight 'y'};
    NBC3.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC3.isFollower = [true; false; false];
    NBC3.isTimeDependent = [false; false; false];
    ...
    NBC4.loadAmplitude = {FAmp4 FAmpWeight};
    NBC4.loadDirection = {dirForce4 dirWeight};
    NBC4.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC4.isFollower = [true; false];
    ...
    NBC5.xiLoadExtension = {xib5 xib5};
    NBC5.etaLoadExtension = {etab5 etab5};
    NBC5.loadAmplitude = {FAmp5 FAmpWeight};
    NBC5.loadDirection = {dirForce5 dirWeight};
    NBC5.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC5.isFollower = [true; false];
    NBC5.isTimeDependent = [false; false];
    ...
    NBC6.xiLoadExtension = {xib6 xib6 xib6};
    NBC6.etaLoadExtension = {etab6 etab6 etab6};
    NBC6.loadAmplitude = {FAmp6 FAmpWeight wind};
    NBC6.loadDirection = {dirForce6 dirWeight 'y'};
    NBC6.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC6.isFollower = [true; false; false];
    NBC6.isTimeDependent = [false; false; false];
    ...
    NBC7.xiLoadExtension = {xib7 xib7 xib7};
    NBC7.etaLoadExtension = {etab7 etab7 etab7};
    NBC7.loadAmplitude = {FAmp7 FAmpWeight wind};
    NBC7.loadDirection = {dirForce7 dirWeight 'y'};
    NBC7.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC7.isFollower = [true; false; false];
    NBC7.isTimeDependent = [false; false; false];
    ...
    NBC8.xiLoadExtension = {xib8 xib8};
    NBC8.etaLoadExtension = {etab8 etab8};
    NBC8.loadAmplitude = {FAmp8 FAmpWeight};
    NBC8.loadDirection = {dirForce8 dirWeight};
    NBC8.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC8.isFollower = [true; false];
    NBC8.isTimeDependent = [false; false];
    ...
    NBC9.xiLoadExtension = {xib9 xib9};
    NBC9.etaLoadExtension = {etab9 etab9};
    NBC9.loadAmplitude = {FAmp9 FAmpWeight};
    NBC9.loadDirection = {dirForce9 dirWeight};
    NBC9.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC9.isFollower = [true; false];
    NBC9.isTimeDependent = [false; false];
    ...
    NBC10.xiLoadExtension = {xib10 xib10};
    NBC10.etaLoadExtension = {etab10 etab10};
    NBC10.loadAmplitude = {FAmp10 FAmpWeight};
    NBC10.loadDirection = {dirForce10 dirWeight};
    NBC10.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC10.isFollower = [true; false];
    NBC10.isTimeDependent = [false; false];
    ...
    NBC11.xiLoadExtension = {xib11 xib11};
    NBC11.etaLoadExtension = {etab11 etab11};
    NBC11.loadAmplitude = {FAmp11 FAmpWeight};
    NBC11.loadDirection = {dirForce11 dirWeight};
    NBC11.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC11.isFollower = [true; false];
    NBC11.isTimeDependent = [false; false];
    ...
    NBC12.xiLoadExtension = {xib12 xib12};
    NBC12.etaLoadExtension = {etab12 etab12};
    NBC12.loadAmplitude = {FAmp12 FAmpWeight};
    NBC12.loadDirection = {dirForce12 dirWeight};
    NBC12.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC12.isFollower = [true; false];
    NBC12.isTimeDependent = [false; false];
    ...
    NBC13.xiLoadExtension = {xib13 xib13};
    NBC13.etaLoadExtension = {etab13 etab13};
    NBC13.loadAmplitude = {FAmp13 FAmpWeight};
    NBC13.loadDirection = {dirForce13 dirWeight};
    NBC13.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC13.isFollower = [true; false];
    NBC13.isTimeDependent = [false; false];
    ...
    NBC14.xiLoadExtension = {xib14 xib14};
    NBC14.etaLoadExtension = {etab14 etab14};
    NBC14.loadAmplitude = {FAmp14 FAmpWeight};
    NBC14.loadDirection = {dirForce14 dirWeight};
    NBC14.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC14.isFollower = [true; false];
    NBC14.isTimeDependent = [false; false];
    ...
    NBC15.xiLoadExtension = {xib15 xib15};
    NBC15.etaLoadExtension = {etab15 etab15};
    NBC15.loadAmplitude = {FAmp15 FAmpWeight};
    NBC15.loadDirection = {dirForce15 dirWeight};
    NBC15.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC15.isFollower = [true; false];
    NBC15.isTimeDependent = [false; false];
    ...
    NBC16.xiLoadExtension = {xib16 xib16};
    NBC16.etaLoadExtension = {etab16 etab16};
    NBC16.loadAmplitude = {FAmp16 FAmpWeight};
    NBC16.loadDirection = {dirForce16 dirWeight};
    NBC16.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC16.isFollower = [true; false];
    NBC16.isTimeDependent = [false; false];
    ...
    NBC17.xiLoadExtension = {xib17 xib17};
    NBC17.etaLoadExtension = {etab17 etab17};
    NBC17.loadAmplitude = {FAmp17 FAmpWeight};
    NBC17.loadDirection = {dirForce17 dirWeight};
    NBC17.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC17.isFollower = [true; false];
    NBC17.isTimeDependent = [false; false];
    ...
    NBC18.xiLoadExtension = {xib10 xib10};
    NBC18.etaLoadExtension = {etab10 etab10};
    NBC18.loadAmplitude = {FAmp10 FAmpWeight};
    NBC18.loadDirection = {dirForce10 dirWeight};
    NBC18.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC18.isFollower = [true; false];
    NBC18.isTimeDependent = [false; false];
    ...
    NBC19.xiLoadExtension = {xib19 xib19};
    NBC19.etaLoadExtension = {etab19 etab19};
    NBC19.loadAmplitude = {FAmp19 FAmpWeight};
    NBC19.loadDirection = {dirForce19 dirWeight};
    NBC19.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC19.isFollower = [true; false];
    NBC19.isTimeDependent = [false; false];
    ...
    NBC20.xiLoadExtension = {xib20 xib20};
    NBC20.etaLoadExtension = {etab20 etab20};
    NBC20.loadAmplitude = {FAmp20 FAmpWeight};
    NBC20.loadDirection = {dirForce20 dirWeight};
    NBC20.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC20.isFollower = [true; false];
    NBC20.isTimeDependent = [false; false];
    ...
    NBC21.xiLoadExtension = {xib21 xib21};
    NBC21.etaLoadExtension = {etab21 etab21};
    NBC21.loadAmplitude = {FAmp21 FAmpWeight};
    NBC21.loadDirection = {dirForce21 dirWeight};
    NBC21.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC21.isFollower = [true; false];
    NBC21.isTimeDependent = [false; false];
    ...
    NBC22.xiLoadExtension = {xib22 xib22};
    NBC22.etaLoadExtension = {etab22 etab22};
    NBC22.loadAmplitude = {FAmp22 FAmpWeight};
    NBC22.loadDirection = {dirForce22 dirWeight};
    NBC22.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC22.isFollower = [true; false];
    NBC22.isTimeDependent = [false; true];
    ...
    NBC23.xiLoadExtension = {xib23 xib23};
    NBC23.etaLoadExtension = {etab23 etab23};
    NBC23.loadAmplitude = {FAmp23 FAmpWeight};
    NBC23.loadDirection = {dirForce23 dirWeight};
    NBC23.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC23.isFollower = [true; false];
    NBC23.isTimeDependent = [false; false];
    ...
    NBC24.xiLoadExtension = {xib24 xib24};
    NBC24.etaLoadExtension = {etab24 etab24};
    NBC24.loadAmplitude = {FAmp24 FAmpWeight};
    NBC24.loadDirection = {dirForce24 dirWeight};
    NBC24.computeLoadVct = {'computeLoadVctAreaIGAThinStructure' 'computeLoadVctAreaIGAThinStructure'};
    NBC24.isFollower = [true; false];
    NBC24.isTimeDependent = [false; false];
...
%     ({BSplinePatches{1}},msh,labelsEnabled,color,graph);
...
color = [217 218 219]/255;
% color = 'none';
graph.isPrestressEnabled = false;
...
% plot_torus3d(center,Radius,radius,thetaInterval,phiInterval,azimuthallySymmetryAxis,color);
% hold on;
% 
% % Plot second tube
% color = [217 218 219]/255;
...
% propNLinearAnalysis.maxIter = 1e3; % 1e3
propNLinearAnalysis.maxIter = 1e3; % 1e3
...
% save(['data_' caseName '_' method '.mat']);
return;
