...
% Read the data
FoFiGeo = importdata('./data_FoFiPool/data_FoFiDDMFourPointSailCoarse.mat');
% FoFiGeo = importdata('./data_FoFiPool/data_FoFiDDMFourPointSailFine.mat');
