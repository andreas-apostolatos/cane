function BCurvature = ...
    computeBOperatorMatrix4CurvatureIGAKirchhoffLoveShellLinear5DOF ...
...
for r = 1:nDOFsEl
    ...
    %% 5ii. Compute the curvature constituents
    % Only first 3 DOFs contribute to curvature (translational DOFs)
    if dir <= 3
        dg(dir,1) = dR(k,2);
        dg(dir,2) = dR(k,4);
    ...
    % DOFs 4 and 5 (rotational) don't contribute to curvature in KL theory
end
