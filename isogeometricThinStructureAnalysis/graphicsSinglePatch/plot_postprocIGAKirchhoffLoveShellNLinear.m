...
% in the reference configuration for the nonlinear analysis.
%
%                    Input :
...
% Plot the window
subplot(2,1,2);
plot_postprocResultantsIGAKirchhoffLoveShellNLinear(p,q,Xi,Eta,CP,isNURBS,parameters,xiGrid,etaGrid,dHat,graph);
