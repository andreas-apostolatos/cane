function [eigenmodeShapes, naturalFrequencies, BSplinePatches, dHat] = ...
    ...
    (BSplinePatches, connections, propCoupling, solve_LinearSystem, ...
    noEig, propNLinearAnalysis, outMsg)
%% Licensing
%
% License:         BSD License
...
%% 3. Assign a number of DOFs for each Lagrange Multipliers field corresponding to the multipatch coupling
if strcmp(couplingMethod, 'Lagrange Multipliers') || ...
...
if strcmp(couplingMethod, 'Penalty') || ...
        ...
        (~(strcmp(couplingMethod, 'Lagrange Multipliers') || ...
        strcmp(couplingMethod, 'augmented Lagrange Multipliers')) && ...
        isfield(propCoupling, 'alphaR'))
...
elseif strcmp(couplingMethod, 'Lagrange Multipliers') || ...
        strcmp(couplingMethod, 'augmented Lagrange Multipliers')
...
[dHat, ~, ~, ~, ~, ~, ~, ~, BSplinePatches, propCoupling, ~] = ...
    ...
    computeTanStiffMtxAndResVct, computeUpdatedGeometry, freeDOFs, homDOFs, ...
...
for iPatches = 1:noPatches
    ...
    for iNBC = 1:NBC.noCnd
        ...
        if NBC.isFollower(iNBC, 1)
            BSplinePatches{iPatches}.FNonConservative = ...
                BSplinePatches{iPatches}.FNonConservative + FGamma;
        end
