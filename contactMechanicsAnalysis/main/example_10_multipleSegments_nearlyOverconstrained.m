...
% lower left corner
x2 = -0.95;               % leads to a nearly overconstrained problem
...
boundaryConditions.dirichlet.segmentv(1,:) = [0.92 0.935];
...
% Contact Boundary for wall segment 1
...
boundaryConditions.contact.isOnU(1) = 1;


% Contact Boundary for wall segment 2
