...
%
% Example: A beam-like structure under alternating force just above a
% contact segment
%
%% Preamble
clc;
...
boundaryConditions.dirichlet.segmentv(1,:) = [0 1];
...
boundaryConditions.neumann.load(1).value = [0 1e3]';

boundaryConditions.neumann.segmentu(2,:) = [0.25 0.5];
boundaryConditions.neumann.segmentv(2,:) = 1;
boundaryConditions.neumann.load(2).type = 'surface_load';
boundaryConditions.neumann.load(2).value = [0 -1e3]';

boundaryConditions.neumann.segmentu(3,:) = [0.5 0.75];
boundaryConditions.neumann.segmentv(3,:) = 1;
boundaryConditions.neumann.load(3).type = 'surface_load';
boundaryConditions.neumann.load(3).value = [0 1e3]';

boundaryConditions.neumann.segmentu(4,:) = [0.75 1];
boundaryConditions.neumann.segmentv(4,:) = 1;
boundaryConditions.neumann.load(4).type = 'surface_load';
boundaryConditions.neumann.load(4).value = [0 -1e3]';
