function [u, FComplete, isConverged,minElASize] = ...
    ...
    (propAnalysis, uSaved, uDotSaved, uDDotSaved, mesh, F, ...
    computebodyForces, parameters, u, uDot, uDDot, massMtx, dampMtx, ...
    computeNLinearMtrcsSteadyState, DOFNumbering, freeDOFs, homDOFs, ...
...
for iLS = 1:propNLinearAnalysis.noLoadSteps
    ...
    for iNR = 1:propNLinearAnalysis.maxIter
        ...
        [tanMtx, resVct, minElASize] = computeNLinearMtrcsSteadyState ...
            ...
            DOFNumbering, mesh, F, loadFactor, propTransientAnalysis, t, ...
