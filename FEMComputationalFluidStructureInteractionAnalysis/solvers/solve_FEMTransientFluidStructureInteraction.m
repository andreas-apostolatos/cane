function [upHistory, dHistory, resVctHistoryFld, resVctHistoryStr, ...
    ...
    propGaussIntStr, propOutputFld, propOutputStr, caseNameFld, ...
    caseNameStr, outMsg)
%% Licensing
%
% License:         BSD License
...
%               propNBCFld : Structure containing information on the
%                            Neumann boundary conditions of the fluid
%               propNBCStr : Structure containing information on the
%                            Neumann boundary conditions of the structure
...
%   solve_FEMCoupledSystem : Function handle to the solution procedure for
%                            the coupled system at each time step
...
[upHistory, dHistory, resVctHistoryFld, resVctHistoryStr, ...
    ...
    (propAnalysisFld, propAnalysisStr, fldMsh, strMsh, DOFNumberingFld, ...
    DOFNumberingStr, freeDOFsFld, freeDOFsStr, homDOFsFld, homDOFsStr, ...
    inhomDOFsFld, inhomDOFsStr, valuesInhomDOFsFld, valuesInhomDOFsStr, ...
    updateInhomDOFsFld, updateInhomDOFsStr, propALE, propALEStr, ...
    computeInitCndsFld, computeInitCndsStr, computeBodyForcesFld, ...
    computeBodyForcesStr, propNBCFld, propNBCStr, computeLoadVctFld, ...
    computeLoadVctStr, propParametersFld, propParametersStr, ...
    solve_FEMCoupledSystem, solve_FEMSystemFld, solve_FEMSystemStr, ...
    computeConstMtxFld, computeConstMtxStr, computeMassMtxFld, ...
    computeMassMtxStr, computeMtxSteadyStateFld, computeMtxSteadyStateStr, ...
    computeUpdatedMeshFld, computeUpdatedMeshStr, solve_LinearSystemFld, ...
    solve_LinearSystemStr, propFldDynamics, propStrDynamics, ...
    propNLinearAnalysisFld, propNLinearAnalysisStr, propFSIFld, propFSIStr, ...
    propFSI, propIDBCFld, propIDBCStr, propPostProcFld, propPostProcStr, ...
    propGaussIntFld, propGaussIntStr, propOutputFld, propOutputStr, ...
    caseNameFld, caseNameStr, pathToOutputFld, pathToOutputStr, titleFld, ...
